...
<body>
	<div id="replyArea">
	  ...
	  <div id="reply" class = "replyclass">
	    <div class="row">
	      <textarea name="rcontent" id="rcontent" rows="3" placeholder="내용을 입력하세요"></textarea>
