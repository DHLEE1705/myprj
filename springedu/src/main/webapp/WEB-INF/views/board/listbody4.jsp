...
<head>
<link rel="stylesheet" href="<c:url value ='/resources/css/list4.css'/>">
<style>
...
<div id="navwrap">
	<nav>
      ...
      <span id = "topfont">용병 모집</span>
     <form:form action = "${pageContext.request.contextPath }/board3/write2"
      ...
      <div id = "writeboard"> 
      	...
      	<div class ="categoryselect">
    		...
    		<div class = "selectcont" id = "selectcontdiv4">
    			<form:select path="wantc" cssClass = "selectc">
                                    <option value="0">== 선 택 ==</option>
                                    <form:options path="wantc" items="${wantc }" itemValue="code" itemLabel="label"/>
                                </form:select>
                                <form:errors path="wantc" cssClass="error4"></form:errors>
    		</div>
      	</div>
      	<div id = "categorytitle">
      	...
      	<div class = "selectcont" id = "selectcontdiv5">
      		...
      		<%-- <form:errors path="boardCategoryVO.cid" cssClass="error5"></form:errors> --%>
      	</div>
      	<div class = "selectcont" id = "selectcontdiv6">
      		...
      		<%-- <form:errors path="stime" cssClass="error5"></form:errors> --%>
      	</div>
    ...
    while (el.hasChildNodes()) {
        el.removeChild (el.lastChild);
      	...
      	<form:errors path="money" cssClass="error6"></form:errors>
				<span class="error6" id="bcontent"></span>
      	<div id = "contentinput">
      		<div id = "toptitle">
      	...
      	<span class="error7" id="bcontent"></span>
      	<div id = "bottom">
