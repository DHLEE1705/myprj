...
public class TestController2 {
	...
	@GetMapping("test/t6")
	public String t6(Person person, Model model){ //${person} 으로 view에서 이용가능
	...
	@GetMapping("test/t7") // ${per}으로 view에서 이용가능
	public String t7(@ModelAttribute("per") Person person, Model model){ //ModelAttribute는 클라이언트에 Person 객체를 전달할때 per로 바꿔줌
...
//입력처리 url / test/t10 post
	...
	public String t11(@Valid @ModelAttribute("per") Person person, 
	...
	//Rest 서비스 할때 client에서 Ajax 호출할때 url 요청 표현방식	
