...
public class EnumWeekMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("월요일 자바공부시간" + day.getStudyHour());
		...
		System.out.println(Week.MONDAY.getRestHour());
		System.out.println(Week.MONDAY.getRestHour2());
	}
}
